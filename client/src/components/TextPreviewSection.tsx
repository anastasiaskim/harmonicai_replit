  ...
  return (
    <Card className="mb-6">
      ...
      <CardContent className="p-6">
        ...
        {/* Text Preview Area */}
        {error ? (
          // If there's an error, show only the error alert (already shown above)
          // and an empty preview area without duplicate error messages
          ...
          // If we have text and no error, display with chapter navigation if available
          <div>
